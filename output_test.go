...
func TestKVOrder(t *testing.T) {
	...
	wantOrder := []string{
		...
		"M365_STATE=", "M365_TASKS=", "M365_MONITORED=", "M365_DISABLED=", "M365_EXCLUDED=",
		"M365_RUNNING=", "M365_FAILED=", "M365_OVERDUE=", "M365_LAST_SUCCESS=",
		"GWS_STATE=", "GWS_TASKS=", "GWS_MONITORED=", "GWS_DISABLED=", "GWS_EXCLUDED=",
		"GWS_RUNNING=", "GWS_FAILED=", "GWS_OVERDUE=", "GWS_LAST_SUCCESS=",
