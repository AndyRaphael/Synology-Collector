...
Full documentation for Synology Collector. New here? Start with the
[project overview](../README.md).

| Guide | What it covers |
|-------|----------------|
| [Installation & building](installation.md) | Download a prebuilt binary or build from source; the pinned Go toolchain. |
| [Configuration reference](configuration.md) | Every flag and environment variable, task selectors, and thresholds. |
